...
def exTest():
    ...
    convert_dict = {
        ...
        "目的種類：分類１": {
            1: 0, 2: 1, 3: 1, 4: 1, 5: 2, 6: 2, 7: 1, 8: 1, 9: 1, 10: 2, 11: 2, 13: 3, 14: 2, 15: 1, 16: 1, 17: 2, 18: 2
        },
    }
    ...
    print("Loading data...")
    dl = make_dataloader(data_files, convert_dict, convert_dict_continuous, change_name_dict)
    ...
    fixed_positions_obj2 = {"License": 0, "Mode": 4}
